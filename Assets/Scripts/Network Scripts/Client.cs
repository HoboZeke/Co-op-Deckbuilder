...
public class Client : NetworkBehaviour
{
    ...
    public void StartMultiplayerGame(string lobbySettings)
    {
        ...
        GameController.main.MoveFromLobbyToGame();
    }

    public void TellServerToStartTheBattle(int locationId)
    {
        server.StartTheBattleServerRpc(playerNumber, locationId);
    }

    public void StartMultiplayerBattle(int locationId)
    {
        GameController.main.StartBattle(locationId);
    ...
    public void RequestServersBoardState()
    {
        server.RequestBoardStateFromServerRpc(playerNumber);
    }
    ...
    {
        debug.DebugEvent("Boardstate recieved from Player " + (int)fromPlayer + " to be verified when ready");
        GameController.main.VerifyBoardStatesWhenReady(boardState, (int)fromPlayer);
    }
